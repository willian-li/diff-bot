...
static constexpr char const * lifecycle_node = "sensor_node";
...
static constexpr char const * node_get_state_topic = "sensor_node/get_state";
static constexpr char const * node_change_state_topic = "sensor_node/change_state";
