   ...
   .. tabs::
      ...
      .. group-tab:: Local
         ...
         .. code-block:: shell
           ...
           ros2 launch servo_control view_robot.launch.py
      ...
      .. group-tab:: Docker
        ...
        .. code-block:: shell
          ...
          docker run -it --rm --name ros2_control_demos --net host ros2_control_demos ros2 launch servo_control view_robot.launch.py gui:=false
   ...
   .. tabs::
      ...
      .. group-tab:: Local
        ...
        .. code-block:: shell
          ...
          ros2 launch servo_control rrbot.launch.py
      ...
      .. group-tab:: Docker
        ...
        .. code-block:: shell
          ...
          docker run -it --rm --name ros2_control_demos --net host ros2_control_demos ros2 launch servo_control rrbot.launch.py gui:=false
...
5. If you get output from above you can send commands to *Forward Command Controller*, either:
   ...
   .. tabs::
      ...
      .. group-tab:: Local
        ...
        .. code-block:: shell
          ...
          ros2 launch servo_control test_forward_position_controller.launch.py
   ...
   .. code-block:: shell
    ...
    [ServoControlHardware]: Got command 0.50000 for joint 0!
    [ServoControlHardware]: Got command 0.50000 for joint 1!
   ...
   .. tabs::
      ...
      .. group-tab:: Local
        ...
        .. code-block:: shell
          ...
          ros2 launch servo_control test_joint_trajectory_controller.launch.py
